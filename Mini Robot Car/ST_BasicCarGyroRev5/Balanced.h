...
void PI_SpeedRing()
{
   ...
   speed_control_output = kp_speed * (speed_filter - 0.0*setting_car_speed) + ki_speed * car_speed_integral;
...
{  
  ...
  rotation_control_output = kp_turn * (setting_turn_speed - kalmanfilter.Gyro_z/3.0); //setting_turn_speed + kp_turn * (setting_turn_speed - kalmanfilter.Gyro_z);
