...
void setup() 
{
  ...
  f_speed = 60; b_speed = 50; t_speed = 30;
  ...
  Mpu6050_init();
  Mpu6050_SetOffset(-5244, 911, 901, -18, 17, 18); // -5321, 874, 920, -19, 13, 23  // these offset values should come from your MPU6050 calibration
